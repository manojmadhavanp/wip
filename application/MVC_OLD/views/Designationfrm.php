<div class="row">
<table width="50%" height="50%" border="0" cellspacing="0" cellpadding="0" id="Designationfrm" class="webgrid">
  <tr>
    <th colspan="5" class="caption"><h3>Designation</h3></th>
    <th width="40%" align="right" class="caption gridbutton"><div class="gridbtn button green animateslow" id="Desgination-" onclick="ShowForm('NewDesignataionfrm',false);"><i class=" icon add"></i>New Designation</div></th>
  </tr>
  <tr>
   <th>Owner</th>
...
<div id="NewDesg" class="formdlg" style="width:400px;">
<?
$desig = new NewDesg();
$desig->NewDesgForm();
?>
