<table width="100%" border="0" cellpadding="0" cellspacing="0" class="appform">
  ...
  <tr>
  <td colspan="2"><form name="Masters-AddNewLocations" id="Masters-AddNewLocations" method="post" action="" onSubmit="return false;">
   ...
   <li><div class="frmitemcaption">State</div><div class="frmitems">
            <select class="fit" name="LState" id="LState" onchange="LoadComboData(this,'Masters-LoadCities');"  ></select> 
            <span class="addbtn" onclick="ShowForm('Statefrm',false);"><i class="icon add"></i></span>
            </div></li>
       z
    <li><div class="frmitemcaption">City</div><div class="frmitems ">
            <select class="fit" name="LCity" id="LCity" onblur="GetAddress('Addressfrm');"
            onchange="LoadComboData(this,'Masters-LoadLocations');" ></select>
