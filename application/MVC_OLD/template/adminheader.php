...
@ your office...</div></h1>
<ul class="nav">
<!--<li><a href="<? echo SITEPATHLOCAL; ?>Admin" class="animateslow php framework" data-content="php framework home">Home</a></li>
<li><a href="<? echo SITEPATHLOCAL; ?>Users" class="animateslow php framework" data-content="php framework home">Users</a></li>
<li><a href="<? echo SITEPATHLOCAL; ?>Masters" class="animateslow php framework" data-content="php framework home">Masters</a></li>-->
